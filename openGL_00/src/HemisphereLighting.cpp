...
//--------------------------------------------------------------
void HemisphereLighting::setup(){
    
}

//--------------------------------------------------------------
void HemisphereLighting::update(){
    //cylinder.pan(-0.1);
    
}

//--------------------------------------------------------------
void HemisphereLighting::draw(){
...
//--------------------------------------------------------------
void HemisphereLighting::reloadShader(){
    
    shader.load("shaders/"+title);
    
}

ofMatrix3x3 HemisphereLighting::mat4ToMat3(ofMatrix4x4 mat4)
{
